<?php  
    ...
    $xml_razonsocial = $xml->createElement('razonSocial', 'Nombre de la empresa');
    $xml_nombrecomer = $xml->createElement('nombreComercial', 'Nombre de la empresa');
    ...
    $xml_totalsinimpuestos = $xml->createElement('totalSinImpuesto', '1.00');
    ...
    $xml_formapago = $xml->createElement('formaPagos', '01');
    ...
    $xml_descripcion = $xml->createElement('descipcion', 'descripcion del producto');
    ...
    $xml_codigoadicional = $xml->createElement('campoAdicional', 'correo');
    ...
    $xml_def->appendChild($xml_totalimpuesto);
    $xml_def->appendChild($xml_tcodigo);
    $xml_def->appendChild($xml_codigoporcen);
    $xml_def->appendChild($xml_baseimpo);
    $xml_def->appendChild($xml_valor);
    ...
    echo 'CREADO' .$xml->save('./no_firmado/'. rand(1, 1000) .'.xml') .'bytes';
?>